...
export function TopBar({
  ...
  return (
    <header className="app-shell-topbar app-shell-titlebar">
      ...
      >
        <div className="app-shell-titlebar-main" data-tauri-drag-region={desktopRuntime ? "" : undefined}>
          <div className="app-shell-titlebar-side">
            ...
            <ShellIconButton
              ariaLabel={rightPanelVisible ? "Hide right panel" : "Show right panel"}
              className={cn(rightPanelVisible && "text-shell-text-primary")}
              disabled={interactionLocked}
              onClick={onToggleRightPanel}
              tooltip={rightPanelVisible ? "Hide panel" : "Show panel"}
            >
              <PanelRightIcon />
            </ShellIconButton>
          </div>

          <div className="app-shell-tabstrip">
            <Tabs
