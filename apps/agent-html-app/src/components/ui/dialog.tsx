  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-[min(92vw,32rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl border border-[color:var(--hairline-strong)] bg-[color:var(--card)] p-6 text-[color:var(--foreground)] shadow-[0_28px_80px_rgba(0,0,0,0.46)] outline-none",
          className,
        )}
