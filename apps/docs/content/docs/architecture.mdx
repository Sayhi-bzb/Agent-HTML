...
`routes.test.mjs` checks route pipeline ownership. `dev-host.test.mjs` checks
Vite dependency aliases, ESM import entries, runtime exports, React singleton
resolution, artifact rendering, and fresh-project startup.
