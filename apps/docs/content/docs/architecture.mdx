...
valid snapshot for Workspace Home before Canvas starts. Theme state flows from
Canvas to Desktop only; Desktop does not send a competing theme into Canvas.
