...
styles/public/content.css
  -> artifact style API entrypoint

styles/public/composition.css
...
`agent-html/styles/public/content.css` owns the public artifact style API
entrypoint. It imports narrower public class owners.

`agent-html/styles/public/composition.css` owns the current L2 composition
...
`canvas-text-body` through `styles/public/content.css` for visual scale. Layout
