...
apps/desktop/src/styles.css
  -> Desktop semantic mappings and centrally owned --canvas-desktop-* values
...
Tailwind, shadcn CSS, fonts, material files, base styles, layout classes, and
internal artifact-adjacent classes.
