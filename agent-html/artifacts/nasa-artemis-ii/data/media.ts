...
const publicUrl = artifactPublicUrlFactory("nasa-artemis-ii")
    ...
    gallery: [
      {
        ...
        credit: "Credit: NASA",
        src: publicUrl("lunar-earthset.jpg"),
      },
      {
        ...
        credit: "Credit: NASA",
        src: publicUrl("lunar-solar-eclipse.jpg"),
      },
      {
        ...
        credit: "Credit: NASA",
        src: publicUrl("lunar-moon-earth.jpg"),
      },
      {
        ...
        credit: "Credit: NASA",
        src: publicUrl("lunar-surface-earth.jpg"),
      },
      {
        ...
        credit: "Credit: NASA",
        src: publicUrl("lunar-window-moon.jpg"),
      },
    ],
  },
  opening: {
