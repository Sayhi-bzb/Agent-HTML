...
export function QuietTokyoBlock() {
  return (
        ...
        <div className="canvas-stack-md">
          <div className="canvas-stack-sm">
            <div className="canvas-wrap-sm items-center">
              ...
              <Badge variant="outline">Quiet Layer</Badge>
              <Badge variant="outline">low stimulus</Badge>
            </div>
            <h2 className="canvas-text-heading">东京也可以很低声量。</h2>
            <p className="canvas-text-body text-muted-foreground">
              Quiet Tokyo is not nostalgia. It is the decision to trade more
              movement for longer stops.
            </p>
          </div>
        ...
        <div className="canvas-stack-md">
          <figure className="canvas-stack-sm">
            <img
              ...
              className="max-h-[440px] w-full rounded-md object-cover"
